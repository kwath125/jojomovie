...
public class CommentController {
	...
	public Map<String, Object> cmtWrite(CommentVo commentVo, Model model) {
		log.info("cmtWrite호출됨");
		
		log.info("여기commentVo : " + commentVo);
		...
		log.info("여기userId : " + userId);
		log.info("여기movieId : " + movieId);
		
		
		boolean result = false;
		
		
		boolean isCmtDup = commentService.isCmtDuplicated(userId, movieId);
