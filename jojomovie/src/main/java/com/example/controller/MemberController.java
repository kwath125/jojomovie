...
import com.example.domain.MoviePageDto;
...
public class MemberController {
	...
	public boolean joinEmailDupCheck(String userEmail, String AuthNum) {
		...
		log.info("userEmail : " + userEmail + "AuthNum : " + AuthNum);
	...
	public boolean joinAuthEmailCheck(String emailAuth, String AuthNum) {
		log.info("joinAuthEmailCheck 호출");
		
		log.info("emailAuth: " + emailAuth + "AuthNum : " + AuthNum);
	...
	public String findId(String userName, String userPhone) {
		log.info("userName : " + userName + ", userPhone :" + userPhone);
