...
<body>
	...
	<div class="container-fluid">
		...
		<form action="/member/login" method="post" id="join" name="frm"  >
			...
			<div class="form-group">
				<label for="password"> 비밀번호 </label> <input type="password" id="passwd"
	...
	$('.findId').on('click','#findIdBtn', function(){ 
		...
		console.log('findName : ' + userName + ", findPhone : " + userPhone);
		...
		$('.findPasswd').on('click','#findPasswdBtn', function(){ 
			...
			console.log('findId : ' + userId + ", findEmail : " + userEmail + ", ranPasswdNum : " + ranPasswdNum);
