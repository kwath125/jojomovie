	...
	<div class="container-fluid">
		...
		<form class="form-horizontal" role="form" id="join" action="/member/join" method="post" name="frm" onsubmit="return validate()">
			<div class="form-group">
				...
				<button type="button" class="btn btn-info dup" onclick="winopen()">아이디중복확인</button>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group col-sm-4 ">
					...
					</span> <input type="password" name="passwd" id="passwd"
			...
			<div class="form-group">
				...
				<div class="input-group col-sm-4">
					<span class="input-group-addon"> <span
						class="glyphicon glyphicon-lock"> </span>
					</span> <input type="password" name="passwdCheck" id="passwdCheck"
			...
			<div class="form-group">
				...
				<div class="input-group col-sm-4">
					...
					</span> <input type="text" name="name" id="name" class="form-control"
			...
			<div class="form-group auth">
				...
				<button type="button" class="btn btn-info" id="emailBtn">인증번호전송</button>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group col-sm-4">
					<span class="input-group-addon"> <span
						class="glyphicon glyphicon-user"> </span>
					</span> <input type="date" name="birthday" id="birthday"
			...
			<div class="form-group">
				...
				<div class="input-group col-sm-4">
					<input type="hidden" id="userAddr" name="userAddr"> <input
						type="text" id="userZipCode" name="userZipCode"
				...
				<input type="text" id="userFirstAddr" name="userFirstAddr"
						class="form-control" readonly="readonly">
				<input type="text" id="userSecondAddr" name="userSecondAddr"
					class="form-control" placeholder="상세주소를 입력하세요."> <input
					type="text" id="userExtraAddr" name="userExtraAddr"
					class="form-control" placeholder="참고 항목">
					</div>
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				</span> <input type="email" id="inputMail" class="form-control"
 ...
 -->
			<div class="form-group">
				...
				<div class="input-group col-sm-4">
					...
					</span> <input type="text" name="phone" id="phone" class="form-control"
						placeholder="휴대전화번호를 입력하세요.">
				</div>
			</div>
			<div class="form-group">
				<input type="hidden" name="point" id="point" value="1000"> <input
					type="hidden" name="grade" id="grade" value="일반"> <input
					type="hidden" name="userIdCheck" id="userIdCheck" value="">
				<input type="hidden" name="emailAuthCheck" id="emailAuthCheck"
					value="">
			</div>
			<div class="form-group">
				<input type="submit" class="btn btn-success" value="회원가입"	onclick="sum()">
				<input type="reset" class="btn btn-danger" value="다시쓰기" class="cancel">
			</div>
	...
	<script>
		...
		function winopen() {
			...
			open('/member/joinIdDupCheck?userId=' + dupId, 'dupCheck',
									...
									.ajax({
										...
										success : function(data) {
											if (data == true) { // 중복값 있을경우
												...
												$(".auth").append( "<br>"
														                +"<label class= 'control-label emailAuth labelEmailAuth' id='labelEmailAuth'>인증번호</label>"
																		+ "<input type='text' id='emailAuth' name='emailAuth' class='form-control'>"
																		+ "<button type='button' class='btn btn-info' id='emailAuthBtn'>인증</button>"
									...
									.ajax({
										...
										success : function(data) {
											if (data == false) {
												...
												$("#emailAuthBtn").prop(
														'disabled', true);
												document.getElementById("createEmailSpan").style.color="green";
												document.getElementById("createEmailSpan").innerHTML = "인증이 완료되었습니다.";
												document.getElementById("emailAuthCheck").value = "ok";
												closeTimer();
